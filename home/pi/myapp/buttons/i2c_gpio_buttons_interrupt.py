...
def buttonpress(channel):
  ...
  execCmd('Station Preset 8 Pressed', ["mpc clear", "mpc load 'Radio Preset'", "mpc play 8"]) if pins2 == 0xfe else False
  execCmd('Station Preset 7 Pressed', ["mpc clear", "mpc load 'Radio Preset'", "mpc play 7"]) if pins2 == 0xfd else False
  execCmd('Station Preset 6 Pressed', ["mpc clear", "mpc load 'Radio Preset'", "mpc play 6"]) if pins2 == 0xfb else False
  execCmd('Station Preset 5 Pressed', ["mpc clear", "mpc load 'Radio Preset'", "mpc play 5"]) if pins2 == 0xf7 else False
